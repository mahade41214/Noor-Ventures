...
class Noorproperties10lac extends StatefulWidget {
  const Noorproperties10lac({super.key});

  @override
  State<Noorproperties10lac> createState() => _Noorproperties10lacState();
}

class _Noorproperties10lacState extends State<Noorproperties10lac> {
  @override
