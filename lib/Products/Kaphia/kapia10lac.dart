...
class Kapia10lac extends StatefulWidget {
  const Kapia10lac({super.key});

  @override
  State<Kapia10lac> createState() => _Kapia10lacState();
}

class _Kapia10lacState extends State<Kapia10lac> {
      ...
      body: Container(
        ...
        child: Column(
          children: [
            ...
            Image.asset("images/kaphiap.jpg",
            ...
            Row(
              ...
              children: [
                Expanded(
                  child: Text(
                    "Kaphia Multi Cuisine Restaurant & Party Center",
                    style: TextStyle(
                        color: Colors.black,
                        fontSize: 20.0,
            ...
            Text(
              "Whether you're a food enthusiast, a corporate client, or a strategic partner, "
                  "Kaphia offers a blend of exquisite culinary delights and premium event "
                  "services. From intimate dinners to large-scale celebrations, "
                  "Kaphia is the perfect choice.Whether you're a food enthusiast, a corporate client, or a strategic partner, "
                  "Kaphia offers a blend of exquisite culinary delights and premium event "
                  "services.",
              style: TextStyle(
                  color: Colors.black,
