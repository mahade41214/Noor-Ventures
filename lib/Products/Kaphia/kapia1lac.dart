...
class Kapia1lac extends StatefulWidget {
  const Kapia1lac({super.key});

  @override
  State<Kapia1lac> createState() => _Kapia1lacState();
}

class _Kapia1lacState extends State<Kapia1lac> {
  @override
